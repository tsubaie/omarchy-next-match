...
eq(M.fixtureHasTeam(fx(), 136013), true, "fixture belongs to configured home team")
eq(M.fixtureHasTeam(fx(), 137721), true, "fixture belongs to configured away team")
eq(M.fixtureHasTeam(fx(), 999), false, "stale fixture for another team is rejected")
eq(M.fixtureHasTeam(null, 136013), false, "missing fixture cannot validate a cache")
